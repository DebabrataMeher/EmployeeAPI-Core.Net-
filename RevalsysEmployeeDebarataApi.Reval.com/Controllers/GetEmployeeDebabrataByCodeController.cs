...
{
    [Route("api/GetEmployeeByCode")]
    [ApiController]
    public class GetEmployeeDebabrataByCodeController : ControllerBase
    {

        private ConfigurationSettingsListDebabrataDTO _ConfigurationSettingsListDTO = null;

        public GetEmployeeDebabrataByCodeController(IOptions<ConfigurationSettingsListDebabrataDTO> options)
        {
        ...
        //****************************************************************************************************
        /// <summary>
        /// <c>GetEmployeeByEmployeeCode</c> This method is used to get the Employee Details based on EmployeeCode parameters.
        /// <param>objAPIRequest</param>
        /// <returns>objContentResult</returns> //It returns the Date Table.
        /// </summary>
        /// 
        [HttpPost]
        public async Task<ContentResult> GetEmployeeDebabrataByCode(RequestDebabrata objAPIRequest)
        {
            ...
            try
            {
                ...
                if (_ConfigurationSettingsListDTO != null)
                {
                    Task<ResponseDebabrata<object>> tskResponse = Task<ResponseDebabrata<object>>.Run(() =>
                    {
                        ...
                        objEmployeeDebabrataResponce = objEmployeeBAL.GetEmployeeDebabrataByCode(objAPIRequest);
